...
public sealed class ForkApplicationCommandHandler
    : IApplicationRequestHandler<ForkApplicationCommand, Result<TenantApplicationDto>>
{
    ...
    public ForkApplicationCommandHandler(
    ...
    public async Task<Result<TenantApplicationDto>> HandleAsync(ForkApplicationCommand request, CancellationToken cancellationToken)
    {
        ...
        var result = Entity.ForkFromPlatform(
            request.TenantId,
